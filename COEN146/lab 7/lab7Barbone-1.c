...
* Author: Daniel Walsh
* Date: 6/2/21
* Title: Dijkstra Algorithm nodes
* Purpose: To implement the dijkstra between four nodes on the same machine
*/
...
receive_info (void *arg)
{
	...
	while(1){
		if(recvfrom(sock, newNodes, sizeof(int) * 3, 0, NULL, NULL) != 12){
